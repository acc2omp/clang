//===--- ExprOpenACC.h - Classes for representing expressions ----*- C++ -*-===//
//
...
namespace clang {
/// \brief OpenACC 4.0 [2.4, Array Sections].
/// To specify an array section in an OpenACC construct, array subscript
...
class ACCArraySectionExpr : public Expr {
...
public:
  ACCArraySectionExpr(Expr *Base, Expr *LowerBound, Expr *Length, QualType Type,
                      ExprValueKind VK, ExprObjectKind OK,
                      SourceLocation ColonLoc, SourceLocation RBracketLoc)
      : Expr(
            ACCArraySectionExprClass, Type, VK, OK,
  ...
  explicit ACCArraySectionExpr(EmptyShell Shell)
      : Expr(ACCArraySectionExprClass, Shell) {}
  ...
  static bool classof(const Stmt *T) {
    return T->getStmtClass() == ACCArraySectionExprClass;
  }
