...
#include "clang/Basic/OpenCLImageTypes.def"
    ...
    enum StmtCode {
      ...
      STMT_ACC_PARALLEL_FOR_VECTOR_DIRECTIVE,
      ...
      STMT_ACC_TASKLOOP_VECTOR_DIRECTIVE,
      STMT_ACC_DISTRIBUTE_DIRECTIVE,
      STMT_ACC_TARGET_UPDATE_DIRECTIVE,
      STMT_ACC_DISTRIBUTE_PARALLEL_FOR_DIRECTIVE,
      STMT_ACC_DISTRIBUTE_PARALLEL_FOR_VECTOR_DIRECTIVE,
      STMT_ACC_DISTRIBUTE_VECTOR_DIRECTIVE,
      STMT_ACC_TARGET_PARALLEL_FOR_VECTOR_DIRECTIVE,
      STMT_ACC_TARGET_VECTOR_DIRECTIVE,
      STMT_ACC_TEAMS_DISTRIBUTE_DIRECTIVE,
      STMT_ACC_TEAMS_DISTRIBUTE_VECTOR_DIRECTIVE,
      STMT_ACC_TEAMS_DISTRIBUTE_PARALLEL_FOR_VECTOR_DIRECTIVE,
