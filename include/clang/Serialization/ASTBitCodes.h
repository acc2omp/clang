...
#include "clang/Basic/OpenCLImageTypes.def"
    ...
    enum DeclCode {
      ...
      /// \brief An ACCThreadPrivateDecl record.
      DECL_ACC_THREADPRIVATE,
      ...
      /// \brief An ACCCapturedExprDecl record.
      DECL_ACC_CAPTUREDEXPR,
      ...
      /// \brief An ACCDeclareReductionDecl record.
      DECL_ACC_DECLARE_REDUCTION,
    ...
    enum StmtCode {
      ...
      STMT_ACC_SIMD_DIRECTIVE,
      STMT_ACC_FOR_DIRECTIVE,
      STMT_ACC_FOR_SIMD_DIRECTIVE,
      STMT_ACC_SECTIONS_DIRECTIVE,
      STMT_ACC_SECTION_DIRECTIVE,
      STMT_ACC_SINGLE_DIRECTIVE,
      STMT_ACC_MASTER_DIRECTIVE,
      STMT_ACC_CRITICAL_DIRECTIVE,
      STMT_ACC_PARALLEL_FOR_DIRECTIVE,
      STMT_ACC_PARALLEL_FOR_SIMD_DIRECTIVE,
      STMT_ACC_PARALLEL_SECTIONS_DIRECTIVE,
      STMT_ACC_TASK_DIRECTIVE,
      STMT_ACC_TASKYIELD_DIRECTIVE,
      STMT_ACC_BARRIER_DIRECTIVE,
      STMT_ACC_TASKWAIT_DIRECTIVE,
      STMT_ACC_FLUSH_DIRECTIVE,
      STMT_ACC_ORDERED_DIRECTIVE,
      STMT_ACC_ATOMIC_DIRECTIVE,
      STMT_ACC_TARGET_DIRECTIVE,
      STMT_ACC_TARGET_DATA_DIRECTIVE,
      STMT_ACC_TARGET_ENTER_DATA_DIRECTIVE,
      STMT_ACC_TARGET_EXIT_DATA_DIRECTIVE,
      STMT_ACC_TARGET_PARALLEL_DIRECTIVE,
      STMT_ACC_TARGET_PARALLEL_FOR_DIRECTIVE,
      STMT_ACC_TEAMS_DIRECTIVE,
      STMT_ACC_TASKGROUP_DIRECTIVE,
      STMT_ACC_CANCELLATION_POINT_DIRECTIVE,
      STMT_ACC_CANCEL_DIRECTIVE,
      STMT_ACC_TASKLOOP_DIRECTIVE,
      STMT_ACC_TASKLOOP_SIMD_DIRECTIVE,
      STMT_ACC_DISTRIBUTE_DIRECTIVE,
      STMT_ACC_TARGET_UPDATE_DIRECTIVE,
      STMT_ACC_DISTRIBUTE_PARALLEL_FOR_DIRECTIVE,
      STMT_ACC_DISTRIBUTE_PARALLEL_FOR_SIMD_DIRECTIVE,
      STMT_ACC_DISTRIBUTE_SIMD_DIRECTIVE,
      STMT_ACC_TARGET_PARALLEL_FOR_SIMD_DIRECTIVE,
      STMT_ACC_TARGET_SIMD_DIRECTIVE,
      STMT_ACC_TEAMS_DISTRIBUTE_DIRECTIVE,
      STMT_ACC_TEAMS_DISTRIBUTE_SIMD_DIRECTIVE,
      STMT_ACC_TEAMS_DISTRIBUTE_PARALLEL_FOR_SIMD_DIRECTIVE,
      STMT_ACC_TEAMS_DISTRIBUTE_PARALLEL_FOR_DIRECTIVE,
      STMT_ACC_TARGET_TEAMS_DIRECTIVE,
      STMT_ACC_TARGET_TEAMS_DISTRIBUTE_DIRECTIVE,
      STMT_ACC_TARGET_TEAMS_DISTRIBUTE_PARALLEL_FOR_DIRECTIVE,
      STMT_ACC_TARGET_TEAMS_DISTRIBUTE_PARALLEL_FOR_SIMD_DIRECTIVE,
      STMT_ACC_TARGET_TEAMS_DISTRIBUTE_SIMD_DIRECTIVE,
