...
static Address emitACCArraySectionBase(CodeGenFunction &CGF, const Expr *Base,
                                       LValueBaseInfo &BaseInfo,
                                       TBAAAccessInfo &TBAAInfo,
...
LValue CodeGenFunction::EmitACCArraySectionExpr(const ACCArraySectionExpr *E,
  ...
  if (auto *VLA = getContext().getAsVariableArrayType(ResultExprTy)) {
    ...
    // the VLA bounds.
    Address Base =
        emitACCArraySectionBase(*this, E->getBase(), BaseInfo, TBAAInfo,
    ...
    Address Base = emitACCArraySectionBase(*this, E->getBase(), BaseInfo,
