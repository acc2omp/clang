...
static Address emitOMPACCArraySectionBase(CodeGenFunction &CGF, const Expr *Base,
                                       LValueBaseInfo &BaseInfo,
                                       TBAAAccessInfo &TBAAInfo,
...
LValue CodeGenFunction::EmitOMPACCArraySectionExpr(const OMPACCArraySectionExpr *E,
  ...
  if (auto *VLA = getContext().getAsVariableArrayType(ResultExprTy)) {
    ...
    // the VLA bounds.
    Address Base =
        emitOMPACCArraySectionBase(*this, E->getBase(), BaseInfo, TBAAInfo,
    ...
    Address Base = emitOMPACCArraySectionBase(*this, E->getBase(), BaseInfo,
