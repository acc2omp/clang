...
class OMPLoopScope : public CodeGenFunction::RunCleanupsScope {
  void emitPreInitStmt(CodeGenFunction &CGF, const OMPLoopLikeDirective &S) {
    ...
    if (auto *LD = dyn_cast<OMPLoopLikeDirective>(&S)) {
...
public:
  OMPLoopScope(CodeGenFunction &CGF, const OMPLoopLikeDirective &S)
...
llvm::Value *CodeGenFunction::getOMPTypeSize(QualType Ty) {
  auto &C = getContext();
  llvm::Value *Size = nullptr;
  auto SizeInChars = C.getTypeSizeInChars(Ty);
  if (SizeInChars.isZero()) {
    // getOMPTypeSizeInChars() returns 0 for a VLA.
...
bool CodeGenFunction::EmitOMPLastprivateClauseInit(
  ...
  if (isOpenMPSimdDirective(D.getDirectiveKind())) {
    auto *LoopDirective = cast<OMPLoopLikeDirective>(&D);
...
void CodeGenFunction::EmitOMPLastprivateClauseFinal(
  ...
  if (auto *LoopDirective = dyn_cast<OMPLoopLikeDirective>(&D)) {
...
void CodeGenFunction::EmitOMPReductionClauseInit(
  ...
  OMPReductionCodeGen RedCG(Shareds, Privates, ReductionOps);
  unsigned Count = 0;
...
void CodeGenFunction::EmitOMPParallelDirective(const OMPParallelDirective &S) {
  ...
  auto &&CodeGen = [&S](CodeGenFunction &CGF, OMPPrePostActionTy &) {
...
void CodeGenFunction::EmitOMPLoopBody(const OMPLoopLikeDirective &D,
                                      JumpDest LoopExit) {
...
bool CodeGenFunction::EmitOMPLinearClauseInit(const OMPLoopLikeDirective &D) {
  if (!HaveInsertPoint())
    return false;
...
void CodeGenFunction::EmitOMPPrivateLoopCounters(
    const OMPLoopLikeDirective &S, CodeGenFunction::OMPPrivateScope &LoopScope) {
  if (!HaveInsertPoint())
    return;
...
static void emitPreCond(CodeGenFunction &CGF, const OMPLoopLikeDirective &S,
...
void CodeGenFunction::EmitOMPLinearClause(
    const OMPLoopLikeDirective &D, CodeGenFunction::OMPPrivateScope &PrivateScope) {
  if (!HaveInsertPoint())
    return;
  llvm::DenseSet<const VarDecl *> SIMDLCVs;
  if (isOpenMPSimdDirective(D.getDirectiveKind())) {
...
void CodeGenFunction::EmitOMPSimdInit(const OMPLoopLikeDirective &D,
                                      bool IsMonotonic) {
...
static void emitOMPSimdRegion(CodeGenFunction &CGF, const OMPLoopLikeDirective &S,
...
void CodeGenFunction::EmitOMPSimdDirective(const OMPSimdDirective &S) {
  auto &&CodeGen = [&S](CodeGenFunction &CGF, OMPPrePostActionTy &Action) {
...
void CodeGenFunction::EmitOMPOuterLoop(
    bool DynamicOrOrdered, bool IsMonotonic, const OMPLoopLikeDirective &S,
...
void CodeGenFunction::EmitOMPForOuterLoop(
    ...
    const OMPLoopLikeDirective &S, OMPPrivateScope &LoopScope, bool Ordered,
...
void CodeGenFunction::EmitOMPDistributeOuterLoop(
    OpenMPDistScheduleClauseKind ScheduleKind, const OMPLoopLikeDirective &S,
...
emitDistributeParallelForInnerBounds(CodeGenFunction &CGF,
                                     const OMPExecutableDirective &S) {
  const OMPLoopLikeDirective &LS = cast<OMPLoopLikeDirective>(S);
  LValue LB =
...
static void emitDistributeParallelForDistributeInnerBoundParams(
  ...
  const auto &Dir = cast<OMPLoopLikeDirective>(S);
  LValue LB =
...
bool CodeGenFunction::EmitOMPWorksharingLoop(
    const OMPLoopLikeDirective &S, Expr *EUB,
...
void CodeGenFunction::EmitOMPTaskBasedDirective(
    ...
    const OMPRegionCodeGenTy &BodyGen, const TaskGenTy &TaskGen,
    OMPTaskDataTy &Data) {
  ...
  auto &&CodeGen = [&Data, &S, CS, &BodyGen, &LastprivateDstsOrigs,
    ...
    if (Data.Reductions) {
      ...
      OMPReductionCodeGen RedCG(Data.ReductionVars, Data.ReductionCopies,
                             Data.ReductionOps);
    ...
    if (!InRedVars.empty()) {
      OMPReductionCodeGen RedCG(InRedVars, InRedPrivs, InRedOps);
...
void CodeGenFunction::EmitOMPTargetTaskBasedDirective(
    const OMPExecutableDirective &S, const OMPRegionCodeGenTy &BodyGen,
  ...
  auto &&CodeGen = [&Data, &S, CS, &BodyGen, BPVD, PVD, SVD,
                    &InputInfo](CodeGenFunction &CGF, OMPPrePostActionTy &Action) {
    // Set proper addresses for generated private copies.
    OMPPrivateScope Scope(CGF);
...
void CodeGenFunction::EmitOMPTaskDirective(const OMPTaskDirective &S) {
  ...
  auto &&BodyGen = [CS](CodeGenFunction &CGF, OMPPrePostActionTy &) {
...
void CodeGenFunction::EmitOMPDistributeLoop(const OMPLoopLikeDirective &S,
...
static void emitTargetTeamsRegion(CodeGenFunction &CGF, OMPPrePostActionTy &Action,
                                  const OMPTargetTeamsDirective &S) {
  auto *CS = S.getCapturedStmt(OMPD_teams);
  Action.Enter(CGF);
  // Emit teams region as a standalone region.
  auto &&CodeGen = [&S, CS](CodeGenFunction &CGF, OMPPrePostActionTy &Action) {
    CodeGenFunction::OMPPrivateScope PrivateScope(CGF);
    (void)CGF.EmitOMPFirstprivateClause(S, PrivateScope);
    CGF.EmitOMPPrivateClause(S, PrivateScope);
    CGF.EmitOMPReductionClauseInit(S, PrivateScope);
...
static void
emitTargetTeamsDistributeRegion(CodeGenFunction &CGF, OMPPrePostActionTy &Action,
                                const OMPTargetTeamsDistributeDirective &S) {
  Action.Enter(CGF);
  auto &&CodeGenDistribute = [&S](CodeGenFunction &CGF, OMPPrePostActionTy &) {
    CGF.EmitOMPDistributeLoop(S, emitOMPLoopBodyWithStopPoint, S.getInc());
  };
...
static void emitTargetTeamsDistributeSimdRegion(
    CodeGenFunction &CGF, OMPPrePostActionTy &Action,
...
void CodeGenFunction::EmitOMPTargetDataDirective(
  ...
  class DevicePointerPrivActionTy : public OMPPrePostActionTy {
    bool &PrivatizeDevicePointers;

  public:
    explicit DevicePointerPrivActionTy(bool &PrivatizeDevicePointers)
        : OMPPrePostActionTy(), PrivatizeDevicePointers(PrivatizeDevicePointers) {}
  ...
  auto &&CodeGen = [&S, &Info, &PrivatizeDevicePointers](
                       CodeGenFunction &CGF, OMPPrePostActionTy &Action) {
    auto &&InnermostCodeGen = [&S](CodeGenFunction &CGF, OMPPrePostActionTy &) {
      CGF.EmitStmt(S.getInnermostCapturedStmt()->getCapturedStmt());
    };
    ...
    auto &&PrivCodeGen = [&S, &Info, &PrivatizeDevicePointers,
                          &InnermostCodeGen](CodeGenFunction &CGF,
                                             OMPPrePostActionTy &Action) {
      OMPRegionCodeGenTy RCG(InnermostCodeGen);
    ...
    OMPRegionCodeGenTy PrivRCG(PrivCodeGen);
...
static void emitTargetParallelRegion(CodeGenFunction &CGF,
  ...
  Action.Enter(CGF);
  auto &&CodeGen = [&S, CS](CodeGenFunction &CGF, OMPPrePostActionTy &) {
    CodeGenFunction::OMPPrivateScope PrivateScope(CGF);
    (void)CGF.EmitOMPFirstprivateClause(S, PrivateScope);
    CGF.EmitOMPPrivateClause(S, PrivateScope);
    CGF.EmitOMPReductionClauseInit(S, PrivateScope);
...
void CodeGenFunction::EmitOMPTaskLoopBasedDirective(const OMPLoopLikeDirective &S) {
  ...
  auto &&BodyGen = [CS, &S](CodeGenFunction &CGF, OMPPrePostActionTy &) {
    // if (PreCond) {
    //   for (IV in 0..LastIteration) BODY;
    //   <Final counter/linear vars updates>;
    // }
  ...
  auto &&TaskGen = [&S, SharedsTy, CapturedStruct,
                    IfCond](CodeGenFunction &CGF, llvm::Value *OutlinedFn,
                            const OMPTaskDataTy &Data) {
    auto &&CodeGen = [&](CodeGenFunction &CGF, OMPPrePostActionTy &) {
      OMPLoopScope PreInitScope(CGF, S);
...
void CodeGenFunction::EmitSimpleOMPExecutableDirective(
  ...
  if (!D.hasAssociatedStmt() || !D.getAssociatedStmt())
    return;
  auto &&CodeGen = [&D](CodeGenFunction &CGF, OMPPrePostActionTy &Action) {
    if (isOpenMPSimdDirective(D.getDirectiveKind())) {
      emitOMPSimdRegion(CGF, cast<OMPLoopLikeDirective>(D), Action);
    } else {
      if (const auto *LD = dyn_cast<OMPLoopLikeDirective>(&D)) {
